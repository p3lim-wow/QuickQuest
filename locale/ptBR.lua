...
L['Hold this key to to temporarily enable automation'] = 'Segure esta tecla para ativar temporariamente a automação'
L['Hold this key to to temporarily disable automation'] = 'Segure esta tecla para desativar temporariamente a automação'
