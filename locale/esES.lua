...
L['Hold this key to to temporarily enable automation'] = 'Mantén pulsada la tecla para activar momentáneamente la opción automática'
L['Hold this key to to temporarily disable automation'] = 'Mantén pulsada la tecla para desactivar momentáneamente la opción automática'
