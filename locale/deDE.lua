...
L['Hold this key to to temporarily enable automation'] = 'Halte diese Taste, um die Automatisierung vorübergehend zu aktivieren'
L['Hold this key to to temporarily disable automation'] = 'Halte diese Taste, um die Automatisierung vorübergehend zu deaktivieren'
